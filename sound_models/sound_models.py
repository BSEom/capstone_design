...
from tensorflow.keras.layers import Dense, Conv2D, SeparableConv2D, Convolution2D, AveragePooling2D
from tensorflow.keras.layers import MaxPooling2D, GlobalAveragePooling2D, GlobalMaxPooling2D, Activation, Dropout, BatchNormalization, Flatten, Input
from tensorflow.keras.models import Model, Sequential
#from keras.applications.mobilenetv2 import MobileNetV2
#model = MobileNetV2(include_top=False, input_shape=(224, 224, 3),weights="imagenet")
#from keras import applications
#model = applications.MobileNetV3(include_top=False, input_shape=(224, 224, 3),weights="imagenet")
